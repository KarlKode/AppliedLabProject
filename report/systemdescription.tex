...
The two applications, the user web interface and the admin panel are developed in python and SAY WHAT WAS USED TO BUILD THE APPLICATION, TO SANITIZE USER INPUT, TO ENSURE CORRECTNESS AND SECURITY, MAYBE ALSO MENTION LOGGING.\newline
